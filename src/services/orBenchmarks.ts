...
export const BENCHMARKS = {
  ...
  network: [
    ...
    {
      id: "taha-three-jug-puzzle",
      title: "Three-Jug Puzzle (Juggling Jugs as Shortest Route)",
      description: "Divide 8 gallons of fluid equally into two 4-gallon parts using 8-, 5-, and 3-gallon jugs in the minimum number of decantations (shortest route model).",
      source: "Hamdy A. Taha - Operations Research: An Introduction (10th Ed.), Chapter 6, Section 6.3, Example 6.3-3",
      data: {
        edges: [
          { from: "(8,0,0)", to: "(3,5,0)", cost: 1 },
          { from: "(8,0,0)", to: "(5,0,3)", cost: 1 },
          { from: "(3,5,0)", to: "(0,5,3)", cost: 1 },
          { from: "(3,5,0)", to: "(8,0,0)", cost: 1 },
          { from: "(3,5,0)", to: "(3,2,3)", cost: 1 },
          { from: "(5,0,3)", to: "(0,5,3)", cost: 1 },
          { from: "(5,0,3)", to: "(8,0,0)", cost: 1 },
          { from: "(5,0,3)", to: "(5,3,0)", cost: 1 },
          { from: "(0,5,3)", to: "(5,0,3)", cost: 1 },
          { from: "(0,5,3)", to: "(3,5,0)", cost: 1 },
          { from: "(3,2,3)", to: "(0,5,3)", cost: 1 },
          { from: "(3,2,3)", to: "(5,0,3)", cost: 1 },
          { from: "(3,2,3)", to: "(6,2,0)", cost: 1 },
          { from: "(3,2,3)", to: "(3,5,0)", cost: 1 },
          { from: "(5,3,0)", to: "(3,5,0)", cost: 1 },
          { from: "(5,3,0)", to: "(2,3,3)", cost: 1 },
          { from: "(5,3,0)", to: "(8,0,0)", cost: 1 },
          { from: "(5,3,0)", to: "(5,0,3)", cost: 1 },
          { from: "(6,2,0)", to: "(3,5,0)", cost: 1 },
          { from: "(6,2,0)", to: "(3,2,3)", cost: 1 },
          { from: "(6,2,0)", to: "(8,0,0)", cost: 1 },
          { from: "(6,2,0)", to: "(6,0,2)", cost: 1 },
          { from: "(2,3,3)", to: "(0,5,3)", cost: 1 },
          { from: "(2,3,3)", to: "(5,0,3)", cost: 1 },
          { from: "(2,3,3)", to: "(5,3,0)", cost: 1 },
          { from: "(2,3,3)", to: "(2,5,1)", cost: 1 },
          { from: "(6,0,2)", to: "(1,5,2)", cost: 1 },
          { from: "(6,0,2)", to: "(5,0,3)", cost: 1 },
          { from: "(6,0,2)", to: "(8,0,0)", cost: 1 },
          { from: "(6,0,2)", to: "(6,2,0)", cost: 1 },
          { from: "(2,5,1)", to: "(0,5,3)", cost: 1 },
          { from: "(2,5,1)", to: "(7,0,1)", cost: 1 },
          { from: "(2,5,1)", to: "(2,3,3)", cost: 1 },
          { from: "(2,5,1)", to: "(3,5,0)", cost: 1 },
          { from: "(1,5,2)", to: "(0,5,3)", cost: 1 },
          { from: "(1,5,2)", to: "(6,0,2)", cost: 1 },
          { from: "(1,5,2)", to: "(1,4,3)", cost: 1 },
          { from: "(1,5,2)", to: "(3,5,0)", cost: 1 },
          { from: "(7,0,1)", to: "(2,5,1)", cost: 1 },
          { from: "(7,0,1)", to: "(5,0,3)", cost: 1 },
          { from: "(7,0,1)", to: "(8,0,0)", cost: 1 },
          { from: "(7,0,1)", to: "(7,1,0)", cost: 1 },
          { from: "(1,4,3)", to: "(0,5,3)", cost: 1 },
          { from: "(1,4,3)", to: "(5,0,3)", cost: 1 },
          { from: "(1,4,3)", to: "(4,4,0)", cost: 1 },
          { from: "(1,4,3)", to: "(1,5,2)", cost: 1 },
          { from: "(7,1,0)", to: "(3,5,0)", cost: 1 },
          { from: "(7,1,0)", to: "(4,1,3)", cost: 1 },
          { from: "(7,1,0)", to: "(8,0,0)", cost: 1 },
          { from: "(7,1,0)", to: "(7,0,1)", cost: 1 },
          { from: "(4,1,3)", to: "(0,5,3)", cost: 1 },
          { from: "(4,1,3)", to: "(5,0,3)", cost: 1 },
          { from: "(4,1,3)", to: "(7,1,0)", cost: 1 },
          { from: "(4,1,3)", to: "(4,4,0)", cost: 1 },
        ],
        startNode: "(8,0,0)",
        endNode: "(4,4,0)",
      },
